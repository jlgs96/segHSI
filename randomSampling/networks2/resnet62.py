...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, gpu_ids=[]):
        ...
        for i in range(n_blocks):
            ...
            #model += [ResnetBlockBOX(ngf * mult, 'zero', norm_layer=norm_layer, use_dropout=use_dropout)]
...
class ResnetBlockBOX(nn.Module):
    '''
    ...
    def __init__(self, dim, padding_type, norm_layer, use_dropout, use_bias = False):
        super(ResnetBlockBOX, self).__init__()
    ...
    def build_conv_block(self, dim, padding_type, norm_layer, use_dropout, use_bias):
        ...
        conv_block += [BoxConv2d(dim, n_boxes, max_input_h, max_input_w,reparametrization_factor=reparam_factor),
                       nn.Conv2d(dim, dim//n_boxes, kernel_size=1, padding=0, bias=use_bias),
                       norm_layer(dim),
                       nn.ReLU(True)]
