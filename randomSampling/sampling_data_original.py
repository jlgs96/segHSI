...
###############################################################################
    ...
    create_splits(loc = osp.join('Aerial Data', 'Image64_2', 'Data-left'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
...
###############################################################################
    ...
    create_splits(loc = osp.join('Aerial Data', 'Image64_2', 'Data-mid'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
...
###############################################################################
    ...
    create_splits(loc = osp.join('Aerial Data', 'Image64_2', 'Data-right'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
