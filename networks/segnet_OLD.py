...
class segnetUp2(nn.Module):
    ...
    def __init__(self, in_size, out_size, max_input_h=64, max_input_w=64, boxdown=False):
        ...
        self.conv1 = conv2DBatchNormRelu(in_size, in_size, 3, 1, 1, max_input_h=max_input_h, max_input_w=max_input_w,boxdown = boxdown)
        max_input_h = max_input_h // 2
        max_input_w = max_input_w // 2
        self.conv2 = conv2DBatchNormRelu(in_size, out_size, 3, 1, 1, max_input_h=max_input_h, max_input_w=max_input_w,boxdown = boxdown)
        max_input_h = max_input_h // 2
        max_input_w = max_input_w // 2
...
class segnetUp3(nn.Module):
    ...
    def __init__(self, in_size, out_size, max_input_h=64, max_input_w=64, boxdown=False):
        ...
        max_input_h = max_input_h // 2
        max_input_w = max_input_w // 2
        self.conv2 = conv2DBatchNormRelu(in_size, in_size, 3, 1, 1, max_input_h=max_input_h, max_input_w=max_input_w,boxdown = boxdown)
        max_input_h = max_input_h // 2
        max_input_w = max_input_w // 2
        self.conv3 = conv2DBatchNormRelu(in_size, out_size, 3, 1, 1, max_input_h=max_input_h, max_input_w=max_input_w,boxdown = boxdown)
        max_input_h = max_input_h // 2
        max_input_w = max_input_w // 2
    def forward(self, inputs, indices, output_shape):
        outputs = self.unpool(input=inputs, indices=indices, output_size=output_shape)
...
class segnet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=21, max_input_h=64, max_input_w=64, boxdown=False):
        ...
        self.up4 = segnetUp3(512, 256,max_input_h=max_input_h, max_input_w=max_input_w,boxdown = boxdown)
